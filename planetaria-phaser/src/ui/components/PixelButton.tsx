...
const PixelButton: React.FC<PixelButtonProps> = ({
  ...
  return (
    <button
      onClick={onClick}
      disabled={disabled}
      className={`cursor-pointer border-4 px-8 py-4 font-['Press_Start_2P'] text-[10px] tracking-wider uppercase transition-all duration-75 select-none active:translate-y-0.5 ${
        disabled
