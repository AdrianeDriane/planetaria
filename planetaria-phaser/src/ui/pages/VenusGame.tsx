...
const VenusGame: React.FC<VenusGameProps> = ({ onComplete, onBack }) => {
  ...
  // Generate non-overlapping positions for trap packets (3 total for balance)
  for (let i = 0; i < 3; i++) {
  ...
  const [dataPackets, setDataPackets] = useState<DataPacket[]>([
    // DATA PACKETS (need to collect all 4)
    {
      ...
      title: "Hot Potato",
      description:
        "Venus is the hottest planet - over 900°F! It's like a giant pizza oven in space!",
      found: false,
      opened: false,
    },
    {
      ...
      title: "Acid Clouds",
      description:
        "It doesn't rain water on Venus; it rains sulfuric acid that would melt your skin!",
      found: false,
      opened: false,
    },
    {
      ...
      description:
        "Venus spins so slowly, one day lasts 243 Earth days - longer than its year!",
      found: false,
      opened: false,
    },
    {
      ...
      title: "Rocky Surface",
      description:
        "Venus has a rocky surface with 1,600+ volcanoes and the same gravity as Earth!",
      found: false,
      opened: false,
    },
    // TRAP PACKETS (use pre-generated non-overlapping positions)
    {
      ...
      description:
        "A micrometeorite struck your telescope lens! Scanning is disabled until you repair it.",
      found: false,
      opened: false,
    },
    {
      ...
      description:
        "Concentrated sulfuric acid vapor engulfs your telescope! Visibility severely reduced.",
      found: false,
      opened: false,
    },
    {
      ...
      description:
        "Atmospheric pressure fluctuations go haywire! Safe zone becomes unpredictable.",
      found: false,
      opened: false,
    },
  ]);
  ...
  const [recentlyOpenedPacket, setRecentlyOpenedPacket] =
    useState<DataPacket | null>(null);
  ...
  useEffect(() => {
    ...
    const interval = setInterval(
      ...
      pressureIsWild ? 500 : 1000
    ); // Faster changes when wild
      ...
      setScanProgress((prev) => {
        ...
        if (newProgress >= 100) {
          ...
          setDataPackets((prevPackets) =>
            prevPackets.map((p) =>
              p.contentType === targetPacket.contentType &&
              p.x === targetPacket.x &&
              p.y === targetPacket.y
                ? { ...p, opened: true }
                : p
          ...
          if (targetPacket.type === "data") {
            ...
            const triviaData = {
              "hot-potato": {
                title: "🔥 Hot Potato",
                description:
                  "Venus is the hottest planet. It's like a giant pizza oven in space!",
                image: "/assets/hot_potato_venus.png",
              ...
              "acid-clouds": {
                title: "☁️ Acid Clouds",
                description:
                  "It doesn't rain water; it rains acid that would sting your skin.",
                image: "/assets/acid_cloud_venus.png",
                contentType: targetPacket.contentType,
              },
              "slow-spinning": {
                title: "🌀 Slow Spinning Venus",
                description:
                  "Venus spins so slowly that you could walk faster than the planet rotates!",
                image: "/assets/slow_spinning_venus.png",
                contentType: targetPacket.contentType,
              },
              rocks: {
                title: "🪨 Rocky Planet",
                description:
                  "No moon, 116 days rotation, same gravity as the Earth.",
                image: "/assets/venus_rock.png",
                contentType: targetPacket.contentType,
              },
            };
  ...
  const handleFlyingButtonClick = () => {
    ...
    const clicksNeeded =
      activeTrap === "acid-mist"
        ? 10
        : activeTrap === "broken-lens"
          ? 8
          : activeTrap === "pressure-spike"
            ? 6
            : activeTrap === "heat-blast"
              ? 8
              : 5;
  ...
  return (
    ...
    >
      ...
      {lightning.map((bolt) => (
        <div
          ...
          style={{
            ...
            width: "4px",
            background:
              "linear-gradient(to bottom, rgba(255,255,200,0.9) 0%, rgba(255,255,150,0.6) 50%, transparent 100%)",
            boxShadow:
              "0 0 20px rgba(255,255,200,0.8), 0 0 40px rgba(255,200,100,0.5)",
      ...
      {particles.map((particle) => (
        <div
          key={particle.id}
          className="pointer-events-none absolute z-14 rounded-full"
          style={{
            left: `${particle.x}px`,
            top: `${particle.y}px`,
      ...
      <div
        className="pointer-events-none absolute inset-0 z-6 transition-opacity duration-1000"
        style={{
      ...
      {acidDrops.map((drop) => (
        ...
        >
          <div
            className="h-8 w-1 bg-linear-to-b from-green-400 to-transparent opacity-60"
            style={{
            ...
            >
              ...
              <div
                ...
                style={{
                  ...
                  border: isAtSafeZone
                    ? "4px solid rgba(34, 197, 128, 1)"
                    : "3px solid rgba(34, 197, 128, 0.6)",
              ...
              <div
                ...
                style={{
                  ...
                  top: "-50px",
                  background:
                    "radial-gradient(circle, rgba(34, 197, 128, 0.3) 0%, transparent 70%)",
              ...
              <div
                ...
                style={{
                  ...
                  top: "-20px",
                  background:
                    "radial-gradient(circle, rgba(34, 197, 128, 0.9) 0%, rgba(34, 197, 128, 0.4) 100%)",
                  boxShadow:
                    "0 0 25px rgba(34, 197, 128, 1), inset 0 0 15px rgba(255, 255, 255, 0.6)",
                }}
              />
              {/* Label */}
              <div
                className="absolute animate-pulse font-['Press_Start_2P'] text-[12px] whitespace-nowrap text-green-400"
                style={{
                  top: "60px",
                  left: "50%",
                  transform: "translateX(-50%)",
                  textShadow:
                    "0 0 10px rgba(34, 197, 128, 1), 0 0 20px rgba(34, 197, 128, 0.8)",
                }}
              >
        ...
        <div className="pointer-events-none absolute inset-0 z-21">
          ...
          >
            <line
              x1={telescopePos.x}
              y1={telescopePos.y}
              x2={telescopePos.x + 200}
              y2={telescopePos.y - 100}
            ...
            <line
              x1={telescopePos.x}
              y1={telescopePos.y}
              x2={telescopePos.x - 150}
              y2={telescopePos.y + 120}
              stroke="rgba(255,255,255,0.6)"
              strokeWidth="2"
            />
            <line
              x1={telescopePos.x}
              y1={telescopePos.y}
              x2={telescopePos.x + 100}
              y2={telescopePos.y + 180}
              stroke="rgba(255,255,255,0.6)"
              strokeWidth="2"
            />
            <line
              x1={telescopePos.x}
              y1={telescopePos.y}
              x2={telescopePos.x - 180}
              y2={telescopePos.y - 80}
              stroke="rgba(255,255,255,0.6)"
              strokeWidth="2"
            />
            <line
              x1={telescopePos.x + 100}
              y1={telescopePos.y - 50}
              x2={telescopePos.x + 150}
              y2={telescopePos.y - 120}
            ...
            />
            <line
              x1={telescopePos.x - 80}
              y1={telescopePos.y + 60}
              x2={telescopePos.x - 120}
              y2={telescopePos.y + 140}
              stroke="rgba(255,255,255,0.4)"
              strokeWidth="1"
            />
          </svg>
      ...
      >
        ...
        {dataPackets.map((packet) => {
          ...
          return (
            <div
              ...
              className="absolute opacity-100 transition-all"
              style={{
                left: `${packet.x}px`,
                top: `${packet.y}px`,
            ...
            >
              ...
              >
                ...
                <div
                  className="pointer-events-none absolute z-10 font-['Press_Start_2P']"
                  style={{
              ...
              {isScanning && (
                <div className="pointer-events-none absolute top-0 left-0 flex h-full w-full items-center justify-center">
                  <svg
                    className={isMobile ? "h-20 w-20" : "h-32 w-32"}
                  ...
                  <span
                    className={`absolute font-['Press_Start_2P'] text-cyan-400 ${isMobile ? "text-[12px]" : "text-xs"}`}
                    style={{
        ...
        {/* Telescope Viewport */}
        <div
          className="pointer-events-none absolute rounded-full border-4 border-cyan-400"
          style={{
        ...
        >
          ...
          {scanningPacket && (
            <div className="absolute inset-0 overflow-hidden rounded-full">
              <div
                className="absolute h-1 w-full bg-linear-to-r from-transparent via-cyan-400 to-transparent opacity-50"
                style={{
        ...
        >
          {/* Main crosshair */}
          <div
            className="absolute top-1/2 left-0 h-0.5 w-full bg-cyan-400"
            style={{ boxShadow: "0 0 4px rgba(34, 197, 234, 0.8)" }}
          />
          <div
            className="absolute top-0 left-1/2 h-full w-0.5 bg-cyan-400"
            style={{ boxShadow: "0 0 4px rgba(34, 197, 234, 0.8)" }}
          />
          ...
          {/* Center dot */}
          <div
            className="absolute top-1/2 left-1/2 h-1 w-1 -translate-x-1/2 -translate-y-1/2 transform rounded-full bg-red-500"
      ...
      <div className="pointer-events-none absolute inset-0 z-30 flex flex-col items-center justify-center gap-6 p-4">
        {/* Instructions Modal */}
        {showInstructions && (
          <div className="bg-opacity-90 pointer-events-auto absolute inset-0 z-50 flex items-center justify-center bg-black">
            <div
              className="mx-2 flex h-[80dvh] max-h-[90dvh] w-[95vw] max-w-2xl flex-col border-2 border-yellow-400 bg-linear-to-b from-orange-900 to-yellow-900 p-2 sm:mx-4 sm:h-auto sm:w-auto sm:border-4 sm:p-8"
              style={{
                boxShadow:
            ...
            >
              {/* Title — fixed at top */}
              <div className="mb-1 shrink-0 text-center sm:mb-6">
                <p
                  className="mb-0.5 font-['Press_Start_2P'] text-[11px] text-yellow-300 sm:mb-2 sm:text-2xl"
                  style={{
                ...
                <p
                  className="font-['Press_Start_2P'] text-[11px] text-orange-300 sm:text-sm"
                  style={{
              ...
              <div className="min-h-0 flex-1 overflow-y-auto">
                {instructionStep === 0 && (
                  <div className="bg-opacity-50 border border-blue-400 bg-black p-2 sm:p-6">
                    <p
                      className="mb-1 font-['Press_Start_2P'] text-[12px] text-blue-300 sm:mb-4 sm:text-xs"
                      style={{
                    ...
                    <p className="font-['Press_Start_2P'] text-[11px] leading-relaxed text-white sm:text-sm">
                      Find all 4 DATA PACKETS to reactivate Venus's planetary
                      core!
                    </p>
                  </div>
                )}
                ...
                {instructionStep === 1 && (
                  <div className="bg-opacity-50 border border-cyan-400 bg-black p-2 sm:p-6">
                    <p
                      className="mb-1 font-['Press_Start_2P'] text-[12px] text-cyan-300 sm:mb-4 sm:text-xs"
                      style={{
                    ...
                    <p className="mb-1 font-['Press_Start_2P'] text-[11px] leading-relaxed text-white sm:mb-4 sm:text-sm">
                ...
                {instructionStep === 2 && (
                  <div className="bg-opacity-50 border border-green-400 bg-black p-2 sm:p-6">
                    <p
                      className="mb-1 font-['Press_Start_2P'] text-[12px] text-green-300 sm:mb-4 sm:text-xs"
                      style={{
                    ...
                    <p className="mb-1 font-['Press_Start_2P'] text-[11px] leading-relaxed text-white sm:mb-4 sm:text-sm">
                      You can ONLY SCAN when pressure is in the SAFE ZONE
                      (40-70).
                    </p>
                    <p className="font-['Press_Start_2P'] text-[11px] leading-relaxed text-white sm:text-sm">
                      If pressure goes red, move to the GREEN BEACON to
                      stabilize it!
                    </p>
                  </div>
                )}
                ...
                {instructionStep === 3 && (
                  <div className="bg-opacity-50 border border-purple-400 bg-black p-2 sm:p-6">
                    <p
                      className="mb-1 font-['Press_Start_2P'] text-[12px] text-purple-300 sm:mb-4 sm:text-xs"
                      style={{
                ...
                {instructionStep === 4 && (
                  <div className="bg-opacity-50 border border-red-400 bg-black p-2 sm:p-6">
                    <p
                      className="mb-1 font-['Press_Start_2P'] text-[12px] text-red-300 sm:mb-4 sm:text-xs"
                      style={{
                ...
                {instructionStep === 5 && (
                  <div className="bg-opacity-50 border border-yellow-400 bg-black p-2 sm:p-6">
                    <p
                      className="mb-1 font-['Press_Start_2P'] text-[12px] text-yellow-300 sm:mb-4 sm:text-xs"
                      style={{
        ...
        {showTitle && !showInstructions && (
          <div className="px-4 text-center">
            <h2 className="mb-1 font-['Press_Start_2P'] text-base text-yellow-500 sm:mb-2 sm:text-2xl">
              CHAPTER 2: VENUS
            </h2>
            <p className="font-['Press_Start_2P'] text-[12px] text-yellow-600 sm:text-xs">
              The Acid Haze
            </p>
            <p className="mt-1 font-['Press_Start_2P'] text-[11px] text-gray-400 sm:mt-2 sm:text-[12px]">
        ...
        {activeTrap && (
          <div
            className="pointer-events-auto absolute z-50 animate-pulse"
            style={{
          ...
          >
            ...
            <button
              ...
              className="relative transform border-2 px-4 py-2 font-['Press_Start_2P'] text-[12px] transition-all hover:scale-110 active:scale-95 sm:border-4 sm:px-6 sm:py-3 sm:text-xs"
              style={{
                backgroundColor:
                  activeTrap === "acid-mist"
                    ? "#10b981"
            ...
            >
              ...
              {activeTrap === "pressure-spike" &&
                `⚡ STABILIZE! (${trapClicks}/6)`}
              {activeTrap === "heat-blast" && `❄️ COOL! (${trapClicks}/8)`}
              {activeTrap === "volcanic-ash" && `💨 CLEAR! (${trapClicks}/5)`}
            </button>
            {/* Instruction text */}
            <div
              className="absolute top-12 left-1/2 -translate-x-1/2 transform animate-bounce font-['Press_Start_2P'] text-[11px] whitespace-nowrap text-yellow-300 sm:top-16 sm:text-[12px]"
              style={{
                textShadow:
                  "0 0 10px rgba(0, 0, 0, 1), 0 0 20px rgba(251, 191, 36, 0.8)",
              }}
            >
              CLICK TO CLEAR TRAP!
            </div>
        ...
        <div className="pointer-events-auto absolute top-1 left-1 sm:top-4 sm:left-4">
          <div
            className={`border border-purple-600 bg-black ${isMobile ? "w-28 p-1" : "w-64 border-4 p-4"}`}
            style={{
          ...
          >
            <p
              className={`font-['Press_Start_2P'] text-purple-400 ${isMobile ? "mb-1 text-[11px]" : "mb-3 text-xs"}`}
              style={{ textShadow: "0 0 8px rgba(168, 85, 247, 0.8)" }}
            >
              {isMobile ? "Pressure" : "Atmospheric Pressure"}
            </p>
            <div
              className={`relative ${isMobile ? "h-4" : "h-8"} overflow-hidden border border-gray-600 bg-gray-800`}
            >
              {/* Safe zone indicator */}
              <div
              ...
              />
              {/* Safe zone markers */}
              <div className="absolute top-0 left-[40%] h-full w-0.5 bg-white" />
              <div className="absolute top-0 left-[70%] h-full w-0.5 bg-white" />
            </div>
            <p
              className={`font-['Press_Start_2P'] ${isMobile ? "mt-0.5 text-[11px]" : "mt-2 text-[12px]"} ${
                inSafeZone ? "text-green-400" : "animate-pulse text-red-400"
              }`}
              style={{
        ...
        <div
          className={`pointer-events-auto absolute ${isMobile ? "top-1 left-[130px]" : "top-4 left-80"}`}
        >
          <div
            className={`border border-yellow-600 bg-black ${isMobile ? "w-20 p-1" : "w-48 border-4 p-3"}`}
            style={{
              boxShadow: isDaytime
          ...
          >
            <div className="flex items-center gap-1">
              ...
              <span
                className={`font-['Press_Start_2P'] text-white ${isMobile ? "text-[11px]" : "text-xs"}`}
        ...
        {(pressureIsWild || heatBlastActive) && (
          <div
            className={`absolute ${isMobile ? "bottom-14 left-1" : "top-96 left-4"} pointer-events-auto`}
          >
            <div
              className={`border border-orange-600 bg-black ${isMobile ? "w-28 p-1" : "w-64 border-4 p-3"}`}
              style={{
                boxShadow: "0 0 10px rgba(251, 146, 60, 0.4)",
              }}
            >
              <p
                className={`font-['Press_Start_2P'] text-orange-400 ${isMobile ? "mb-0.5 text-[11px]" : "mb-2 text-[12px]"}`}
              ...
              {pressureIsWild && (
                <p
                  className={`text-yellow-300 ${isMobile ? "text-[10px]" : "text-[12px]"} mb-1`}
                >
                  • Pressure!
                </p>
              )}
              {heatBlastActive && (
                <p
                  className={`text-red-300 ${isMobile ? "text-[10px]" : "text-[12px]"} mb-1`}
                >
                  • Heat blast!
                </p>
              )}
              <p
                className={`text-gray-400 ${isMobile ? "mt-0.5 text-[10px]" : "mt-2 text-[12px]"}`}
              >
                Wait for effects...
              </p>
            </div>
        ...
        {isMobile && (
          <button
            ...
            className="pointer-events-auto absolute top-1 right-1 z-50 rounded border border-yellow-600 bg-yellow-800 p-1.5"
            style={{
          ...
          >
            ...
            <span className="mt-0.5 block font-['Press_Start_2P'] text-[10px] text-yellow-400">
              {dataPackets.filter((p) => p.opened && p.type === "data").length}
              /4
            </span>
          </button>
        )}
        ...
        {(!isMobile || isChecklistOpen) && (
          <div
            className={`absolute ${isMobile ? "top-8 right-1" : "top-4 right-4"} pointer-events-auto z-40 flex flex-col gap-1 ${isMobile ? "max-h-[70vh] w-36 overflow-y-auto" : "w-72 gap-4"}`}
            style={
              isMobile
                ? {
          ...
          >
            <div
              className={`border border-yellow-700 bg-black ${isMobile ? "p-1" : "border-4 p-4"}`}
              style={{
                boxShadow: "0 0 8px rgba(161, 98, 7, 0.3)",
              }}
            >
              <p
                className={`font-['Press_Start_2P'] text-yellow-400 ${isMobile ? "mb-1 text-[11px]" : "mb-3 text-xs"}`}
              ...
              <div className="space-y-2">
                {dataPackets
                  ...
                  .map((packet) => {
                    ...
                    if (packet.opened) {
                      statusText =
                        packet.contentType === "hot-potato"
                          ? "🔥 HOT POTATO"
                          : packet.contentType === "acid-clouds"
                            ? "☁️ ACID CLOUDS"
                            : packet.contentType === "slow-spinning"
                              ? "🌀 SLOW SPIN"
                              : "🪨 ROCKS";
                    ...
                    return (
                      <div
                        key={`${packet.contentType}-${packet.x}`}
                        className={`${isMobile ? "p-0.5 text-[10px]" : "p-2 text-[12px]"} border font-['Press_Start_2P'] transition-all ${borderColor} ${bgColor} ${statusColor} ${packet.opened ? "cursor-pointer hover:brightness-125" : ""}`}
              ...
              <div
                className={`${isMobile ? "mt-1 pt-1" : "mt-3 pt-3"} border-t border-yellow-700`}
              >
                <p
                  className={`text-blue-300 ${isMobile ? "text-[10px]" : "text-[12px]"} font-['Press_Start_2P']`}
                >
                  Data Found:{" "}
                  {
                    dataPackets.filter((p) => p.opened && p.type === "data")
                      .length
                  }
                  /4
                </p>
            ...
            {recentlyOpenedPacket && (
              <div
                className={`animate-pulse border bg-black ${isMobile ? "p-1" : "border-4 p-4"} ${recentlyOpenedPacket.type === "data" ? "border-blue-500" : "border-red-500"}`}
                style={{
                  boxShadow:
                    recentlyOpenedPacket.type === "data"
                      ? "0 0 10px rgba(96, 165, 250, 0.4)"
                      : "0 0 10px rgba(239, 68, 68, 0.4)",
                }}
              >
                <p
                  className={`font-['Press_Start_2P'] ${isMobile ? "mb-0.5 text-[10px]" : "mb-2 text-xs"} ${recentlyOpenedPacket.type === "data" ? "text-blue-400" : "text-red-400"}`}
                  style={{
                    textShadow:
                      recentlyOpenedPacket.type === "data"
                ...
                <p
                  className={`${isMobile ? "text-[10px]" : "text-xs"} leading-relaxed text-gray-300`}
                >
                  {recentlyOpenedPacket.contentType === "hot-potato"
                    ? "Hot potato data packet - handles with extreme heat!"
                    : recentlyOpenedPacket.contentType === "acid-clouds"
                      ? "Acid cloud composition analysis retrieved!"
                      : recentlyOpenedPacket.contentType === "slow-spinning"
                        ? "Venus rotation speed data collected!"
                        : recentlyOpenedPacket.contentType === "rocks"
                          ? "Volcanic rock samples catalogued!"
                          : recentlyOpenedPacket.contentType === "broken-lens"
                            ? "Lens shattered! Scanning disabled!"
                            : recentlyOpenedPacket.contentType === "acid-mist"
                              ? "Acid mist released! Vision obscured!"
                              : recentlyOpenedPacket.contentType ===
                                  "pressure-spike"
                                ? "Pressure going wild for 15 seconds!"
                                : recentlyOpenedPacket.contentType ===
                                    "heat-blast"
                                  ? "Heat blast causing intense shaking!"
            ...
            {allFound && (
              <div
                className={`animate-pulse border border-green-500 bg-green-900 ${isMobile ? "p-1" : "border-4 p-4"}`}
                style={{
                  boxShadow: "0 0 15px rgba(34, 197, 128, 0.5)",
                }}
              >
                <p
                  className={`text-center font-['Press_Start_2P'] text-green-300 ${isMobile ? "text-[10px]" : "text-xs"}`}
                  style={{ textShadow: "0 0 10px rgba(34, 197, 128, 1)" }}
                >
                  ⭐ All Found! ⭐
                </p>
                <div
                  className={`text-center ${isMobile ? "text-sm" : "mt-2 text-2xl"}`}
                >
                  🌋✨🌋
                </div>
              </div>
        ...
        {showCompletionModal && (
          <div className="bg-opacity-85 pointer-events-auto absolute inset-0 z-50 flex items-center justify-center bg-black p-1 sm:p-4">
            <div
              className={`relative border border-green-400 bg-linear-to-b from-green-900 to-teal-900 ${isMobile ? "mx-2 w-full max-w-sm p-3" : "mx-4 w-full max-w-2xl border-4 p-8"}`}
              style={{
                boxShadow:
                  "0 0 40px rgba(34, 197, 128, 0.8), 0 0 80px rgba(34, 197, 128, 0.4)",
              }}
            >
              {/* Stars / celebration */}
              <div className={`text-center ${isMobile ? "mb-2" : "mb-4"}`}>
                <div
                  className={`${isMobile ? "mb-1 text-2xl" : "mb-3 text-4xl"}`}
                >
                  🌟 🚀 🌟
                </div>
                <p
                  className={`font-['Press_Start_2P'] text-green-300 ${isMobile ? "text-[11px]" : "text-lg"}`}
              ...
              {/* Divider */}
              <div
                className={`border-t border-green-600 ${isMobile ? "my-2" : "my-4"}`}
              />

              {/* Summary */}
              <div
                className={`bg-opacity-50 border border-green-700 bg-black ${isMobile ? "mb-3 p-2" : "mb-6 border-2 p-4"}`}
              >
                <p
                  className={`text-center font-['Press_Start_2P'] leading-relaxed text-green-200 ${isMobile ? "text-[5px]" : "text-xs"}`}
                  style={{ textShadow: "0 0 8px rgba(134, 239, 172, 0.6)" }}
                >
                  All 4 data packets recovered from Venus orbit.
                  {!isMobile && "\n"}The S.S. Astra is ready to plot a course to
                  Earth.
                </p>
              </div>

              {/* Collected packets list with fact descriptions */}
              <div
                className={`grid grid-cols-1 gap-2 ${isMobile ? "mb-3" : "mb-6"}`}
              >
                {dataPackets
                  .filter((p) => p.type === "data")
                  .map((p) => (
                    <div
                      key={p.id}
                      className={`bg-opacity-40 flex items-start gap-2 border border-green-800 bg-black ${isMobile ? "p-0" : "p-1"}`}
                    >
                      <span className={`${isMobile ? "text-base" : "text-xl"}`}>
                        {p.contentType === "hot-potato"
                          ? "🔥"
                          : p.contentType === "acid-clouds"
                            ? "☁️"
                      ...
                      <div>
                        <p
                          className={`font-['Press_Start_2P'] text-green-300 ${isMobile ? "text-[10px]" : "text-[11px]"}`}
                        >
                          {p.title}
                        </p>
                        <p
                          className={`mt-1 font-['Press_Start_2P'] leading-relaxed text-green-200/80 ${isMobile ? "text-[7px]" : "text-[9px]"}`}
                        >
                          {p.description}
                        </p>
                      </div>
        ...
        {showTriviaModal && triviaContent && (
          <div
            className="bg-opacity-80 pointer-events-auto absolute inset-0 z-50 flex items-center justify-center bg-black p-1 sm:p-4"
            onClick={() => setShowTriviaModal(false)}
          >
            <div
              className={`relative max-h-[90vh] overflow-y-auto border border-yellow-400 bg-linear-to-b from-purple-900 to-blue-900 ${isMobile ? "mx-1 max-w-sm p-2" : "mx-4 max-w-3xl border-4 p-8"}`}
              style={{
                boxShadow:
                  "0 0 40px rgba(251, 191, 36, 0.8), 0 0 80px rgba(251, 191, 36, 0.4)",
              }}
            ...
            >
              ...
              <button
                onClick={() => setShowTriviaModal(false)}
                className="absolute top-1 right-1 px-2 font-['Press_Start_2P'] text-sm text-yellow-400 hover:text-yellow-200 sm:top-2 sm:right-2 sm:text-xl"
                style={{
                  textShadow: "0 0 8px rgba(251, 191, 36, 1)",
                }}
              >
              ...
              <div className={`text-center ${isMobile ? "mb-2" : "mb-6"}`}>
                <p
                  className={`font-['Press_Start_2P'] text-yellow-300 ${isMobile ? "mb-0.5 text-[11px]" : "mb-2 text-sm"}`}
                  style={{
                ...
                <p
                  className={`font-['Press_Start_2P'] text-white ${isMobile ? "text-[12px]" : "text-2xl"}`}
                  style={{
              ...
              <div
                className={`flex ${isMobile ? "mb-2 flex-row gap-2" : "mb-6 flex-col gap-6 sm:flex-row"}`}
              >
                {/* Data Packet Image */}
                <div className="mx-auto shrink-0 sm:mx-0">
                  {triviaContent.contentType === "slow-spinning" ? (
                    <div
                      className={`relative overflow-hidden ${isMobile ? "h-20 w-20" : "h-48 w-48"}`}
                      style={{
                    ...
                    >
                      <div
                        style={{
                          ...
                          height: "600%", // 6 frames
                          backgroundImage:
                            "url(/assets/slow_spinning_venus.png)",
                    ...
                    <img
                      ...
                      alt="Data Packet"
                      className={`object-contain ${isMobile ? "h-20 w-20" : "h-48 w-48"}`}
                      style={{
                        filter: "drop-shadow(0 0 20px rgba(96, 165, 250, 0.8))",
                      }}
                    />
                ...
                {/* Description */}
                <div
                  className={`bg-opacity-50 flex flex-1 items-center border border-blue-400 bg-black ${isMobile ? "p-1.5" : "border-2 p-6"}`}
                >
                  <p
                    className={`font-['Press_Start_2P'] leading-relaxed text-blue-200 ${isMobile ? "text-[11px]" : "text-base"}`}
                    style={{
